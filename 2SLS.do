...
/* TQ = y */
/* OLS */
regress TQ CHSptc ROA PE EBITmargin RD DEA
...
regress ROA CHSptc PE EBITmargin RD DEA
ivreg ROA PE EBITmargin RD DEA (CHSptc = CHSptc_inst2)
reg CHSptc CHSptc_inst2

quietly ivreg ROA PE EBITmargin RD DEA (CHSptc = CHSptc_inst2)
est store IV_reg
quietly regress ROA CHSptc PE EBITmargin RD DEA
est store LS_reg
hausman IV_reg LS_reg 
